export function Speed(){
    return(
        <div className='w-full h-full p-2 flex flex-row justify-between items-center hover:bg-indigo-500/40 transition-all duration-150 ease-in-out cursor-pointer'>
